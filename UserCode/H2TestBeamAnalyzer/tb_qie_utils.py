...
def setHist(hist, xtitle, ytitle, xrange_=0, yrange_=0, yoff=None, color=ROOT.kBlack, style=1, width=2):
    setHistBasic(hist)
...
def setHist2D(hist, xtitle, ytitle, ztitle, xrange_=0, yrange_=0, zrange_=0, xoff=None, yoff=None, zoff=None):
    setHistBasic(hist)
    hist.GetYaxis().SetTitle(ytitle)
    hist.GetXaxis().SetTitle(xtitle)
