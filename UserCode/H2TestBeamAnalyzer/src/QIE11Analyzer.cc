...
// Class:      QIE11Analyzer
// 
/**\class QIE11Analyzer QIE11Analyzer.cc UserCode/H2TestBeamAnalyzer/src/QIE11Analyzer.cc

 Description: Analyzer for QIE11 output

 Implementation:
     [Notes on implementation]
*/
//
// Original Author:  Nadja Strobbe & Joe Pastika
...
class QIE11Analyzer : public edm::EDAnalyzer {
   public:
      explicit QIE11Analyzer(const edm::ParameterSet&);
      ~QIE11Analyzer();
...
//
QIE11Analyzer::QIE11Analyzer(const edm::ParameterSet& iConfig) :
...
void QIE11Analyzer::getData(const edm::Event &iEvent, 
		const edm::EventSetup &iSetup)
{
    ...
    // Now extracting QIE11 information
	...
	*/
    ...
    const QIE11DigiCollection& c=*(qie11DigiCollection);
	...
	std::cout << c[j].samples() << std::endl;
      }

      // Extract info on detector location
      DetId detid = c[j].detid();
...
void
QIE11Analyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
QIE11Analyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
QIE11Analyzer::endJob() 
{
//	_file->Write();
//	_file->Close();
}
...
void 
QIE11Analyzer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
QIE11Analyzer::endRun(edm::Run const&, edm::EventSetup const&)
{
//	_file->Write();
//	_file->Close();
}
...
void 
QIE11Analyzer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
QIE11Analyzer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
QIE11Analyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(QIE11Analyzer);
