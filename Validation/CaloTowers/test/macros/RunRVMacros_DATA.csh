...
#Process Startup JetHT
#root -b -l -q 'RelValMacro.C("'${OLD_VERS}_Startup'","'${NEW_VERS}_Startup'","'HcalRecHitValidationRelVal_JetHT_${OLD_VERS}.root'","'HcalRecHitValidationRelVal_JetHT_${NEW_VERS}.root'","InputRelVal_Medium_DATA.txt")'
